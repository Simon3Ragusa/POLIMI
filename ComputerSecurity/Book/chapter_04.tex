...
Questions about this topic are usually based on identifying assets, threats, and countermeasures for a given scenario (e.g., floor cleaning robots, tracking devices). You may also be asked to correct a Risk Analysis Table by evaluating Likelihood/Impact and to suggest potential attack surfaces.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Exam Insight]
Exam questions often ask you to analyze the security of custom authentication mechanisms (e.g., password recovery, biometrics, hardware protocols). Be prepared to identify weaknesses such as snooping or guessing, and suggest improvements.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Exam Insight]
When analyzing vulnerabilities and proposing mitigations for a given scenario, keep in mind how flaws in access control models (like DAC's susceptibility to Trojans) can be exploited. You will need to explain the exploit mechanics and propose architectural countermeasures.
\end{tcolorbox}
