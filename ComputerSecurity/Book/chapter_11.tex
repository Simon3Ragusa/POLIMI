...
\begin{enumerate}
    ...
    Questions about this topic often involve analyzing PKI and Certificate practices. You might be asked to evaluate certificate validation steps, analyze different PKI architectures, or discuss the implications of certificate lifetime reduction.
    \end{tcolorbox}
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Exam Insight]
Questions about this topic usually ask you to propose network mitigations (such as HTTPS/HSTS) to prevent specific attacks, or evaluate the effectiveness of these protocols in defending against MITM and eavesdropping.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Exam Insight]
While SET is a legacy protocol, understanding its cryptographic protocol design (such as the dual signature) is useful for exercises that ask you to analyze or design custom secure cryptographic protocols for confidentiality and integrity.
\end{tcolorbox}
