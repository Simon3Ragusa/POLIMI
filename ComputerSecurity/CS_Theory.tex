...
This document contains theoretical notes on Computer Security.

\section{Cryptography}

Cryptography is the study of secure communication techniques that aim to guarantee confidentiality, integrity, and authenticity for data in transit and at rest.

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image1.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image3.png} \end{figure}

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image4.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image5.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image9.png} \end{figure}

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image10.png} \end{figure}

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image13.png} \end{figure}
...
Hence, a perfectly secure system is not necessarily perfectly usable.

Because perfect security often conflicts with practical usability, modern cryptography relies on \textbf{computationally secure ciphers} instead.
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image16.png} \end{figure}

and produces a longer string:

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image17.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image18.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image19.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image20.png} \end{figure}
...
Therefore, a Pseudorandom Function (PRF) is practically indistinguishable from a Random Function (RF) from the perspective of an efficient, computationally bounded attacker.
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image21.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image22.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image23.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image26.png} \end{figure}

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image27.png} \end{figure}
...
Therefore, encryption does not equate to integrity.
Encryption alone hides the content, but it does not guarantee that the message has not been secretly modified.
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image28.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image29.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image30.png} \end{figure}
...
For instance, given a message block sequence A B C that produces TAG1, an attacker attempting to forge TAG2 for the sequence A B C D only needs to resume the computation from TAG1 rather than starting from the beginning.
...
A possible fix is to encrypt the final result once more. This way, the attacker no longer directly observes the \textbf{final internal state} of the CBC-MAC.
...
To clarify the distinction: second preimage resistance means that given a specific message, it is difficult to find another message with the same hash. Collision resistance means that it is difficult to find any two arbitrary messages that produce the same hash.

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image31.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image32.png} \end{figure}
...
The core idea is to securely combine the message and the secret key in a controlled manner before calculating the tag.
...
A fundamental problem in symmetric cryptography is how two communicating parties can establish a shared secret key if they only have access to a public, insecure channel.
...
To address these challenges, asymmetric cryptography introduces three main primitives:
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image33.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image34.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image35.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image36.png} \end{figure}
...
Therefore, a public key does not inherently prove identity.
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image44.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image45.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image46.png} \end{figure}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{media/image47.png} \end{figure}
...
One of the primary goals of this attack is to steal cookies or other private information.

\textbf{To defend} against XSS, user input must always be treated as \textbf{text} rather than executable code. Hence, the content must be filtered, validated, and properly escaped before being displayed to other users.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item The malicious code is stored on the target server's database (for example, in a message forum). Later, when a victim loads the web page, the malicious code is fetched and executed by the browser if it was not adequately filtered.
...
To defend against this, one might consider allowlisting only alphanumeric characters in username and password fields. However, this would interfere with the application's functionality, as passwords often require special characters.

Another approach is using a blocklist, but this remains problematic since SQL provides alternative operators and expressions (for instance, the '=' operator can often be substituted with 'LIKE').

The \textbf{correct solution} is to entirely avoid building SQL queries through raw string concatenation.
...
paths}. Suppose a compromised machine is connected to the LAN but also possesses a direct, unmonitored connection to the internet (such as a cellular modem). This creates a backdoor that completely bypasses the firewall.
\end{document}
